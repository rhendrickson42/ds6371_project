...
The Forward selection model is satisfying all below condition after performing transfermation on some of the variables.
...
After accounting for all other possible confounders (that we measured), and holding them fixed, we estimate that for each additional $100 spent on a student in the U.S. (excluding Alaska), his or her estimated SAT score increases 3.38514 points (p-value from MLR < .0001).  A 95% confidence interval is (1.82, 4.95) points.  
...
|-------------------|:-----------:|:--------:|:------------:|
| Forward           | 0.8801      | 23.6     | .201         |
| Backward          | 0.8801      | 23.3     | .201         |
| Stepwise          | 0.8801      | 23.8     | .201         |
| Custom*           | 0.8518      | 23.2     | .201         |
 
 * custom method choosen was Forward(select=SL)
### Conclusion

Based on after accounting for all other possible confounders (that we measured), and holding them fixed, we estimate that for each additional $100 spent on a student in the U.S. (excluding Alaska), his or her estimated SAT score increases 3.38514 points (p-value from MLR < .0001).  A 95% confidence interval is (1.82, 4.95) points.  
